...
\begin{longtable}{@{}p{.2\textwidth} p{.8\textwidth}}
  ...
  Planung, test-getriebene Implementierung und Dokumentation von Funktionalitäten, Schnittstellen-Design, Datenbank-Management, Datenanalyse, Release-Koordination
  \\
  09/2018 - 08/2021 &
  ReactiveRobotics GmbH, München (Medizinrobotik für Intensivstationen) \newline
  Junior Software-Entwickler \newline
  GUI-Entwicklung, Robotik-Steuerung
\end{longtable}

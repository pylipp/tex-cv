...
\begin{longtable}{@{}p{.2\textwidth} p{.8\textwidth}}
  seit 09/2021 &
  Stichting boxwise, Niederlande (Anwendung für Logistik in der Humanitärhilfe) \newline
...
\begin{longtable}{@{}p{.2\textwidth} p{.8\textwidth}}
  09/2020 - 11/2020 &
  Permakultur-Akadamie Deutschland e.V. \newline
...
\begin{multicols}{2}
  \begin{itemize}
    \item API Design (GraphQL, ariadne)
    \item Test-driven development
    \item GUI-Entwicklung (Qt, QML, PyQt)
    \item Datenbank-Management (peewee, MySQL)
